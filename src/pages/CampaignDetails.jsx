        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
          ...
          <div>
            ...
            <div className='mt-[20xp]'>
              <p className='mt-[4px] font-epilogue font-normal text-[16px] leading-[26px] text-justify text-[#808191]'>{state.description}</p>
            </div>
          </div>
            ...
            <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
                ...
                <div className='mt-[30px]'>
                  <input 
                    ...
                    placeholder='ETH 0.1'
                    step="0.01"
                    className='w-full py-[10px] sm:px-[20px] px-[15px] outline-none border-[1px] border-[#3a3a43] bg-transparent 
                    font-epilogue text-white text-[18px] leading-[30px] placeholder:text-[#4b5264] rounded-[10px]'
                    value={amount}
